...
# BUYING POWER SPLIT: Quant Trader gets 50%, LAUREN gets 50%
BUYING_POWER_SHARE = 0.50      # This system uses 50% of total buying power

MAX_POSITION_PCT = 0.35        # 35% of OUR SHARE per position
MAX_POSITIONS = 3              # Maximum concurrent positions
MAX_EXPOSURE_PCT = 0.95        # 95% of OUR SHARE max deployed
